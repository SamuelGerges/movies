...
@push('scripts')
    ...
    <script>
        ...
        let rolesTable = $('#roles-table').DataTable({
            dom: "tiplr",  //  tiplr  => stands for table information pagination length process
            serverSide: true,
            processing: true,
            "language": {
            ...
            drawCallback: function (settings) {
                // prop () this method should be used to retrieve property values
                $('.record__select').prop('checked', false);    // retrieve property values from #id => record_select
